...
const Footer: React.FC<FooterProps> = ({ description }) => {
  return (
    <footer className="bg-onyx pt-20 pb-40 px-6 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="col-span-1 lg:col-span-2">
          ...
          <div className="flex gap-4">
            {[Instagram, Facebook, Linkedin].map((Icon, i) => (
              <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-accent hover:text-black transition-colors duration-300">
                <Icon size={20} />
              </a>
            ))}
          </div>
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col justify-center">
          <div className="grid gap-6">
            <a href="mailto:info@effectwave.ly" className="flex items-center gap-4 group">
              ...
              <div>
                <div className="text-xs text-silver/50 uppercase tracking-wider mb-1">Email Us</div>
            ...
            <div className="flex items-center gap-4 group">
              ...
              <div>
                <div className="text-xs text-silver/50 uppercase tracking-wider mb-1">Call Us</div>
                <div className="text-xl text-white font-english group-hover:text-accent transition-colors duration-300 dir-ltr">
                  094 468 9827 | 091 882 4194
                </div>
              </div>
            </div>
            ...
            <a href="https://www.effectwave.ly" className="flex items-center gap-4 group">
              ...
              <div>
                <div className="text-xs text-silver/50 uppercase tracking-wider mb-1">Visit Us</div>
