        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {cards.map((card, idx) => (
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-heading font-bold text-white mb-4">{card.title}</h3>
              <p className="text-silver text-sm md:text-base leading-relaxed">{card.text}</p>
            </motion.div>
          ))}
        </div>
      </div>
